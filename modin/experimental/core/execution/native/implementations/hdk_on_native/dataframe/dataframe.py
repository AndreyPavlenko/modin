...
class HdkOnNativeDataframe(PandasDataframe):
                ...
                if (
                    ...
                    for col in table_columns:
                        if col in frame_dtypes:
                            ...
                            if (
                                frame._index_cols is not None
                                and len(frame._index_cols) == 1
                            ):
                                expr = frame.ref(frame._index_cols[0])
                            else:
                                expr = InputRefExpr(
                                    frame, ROWID_COL_NAME, get_dtype(int)
                                )
                        else:
    ...
    def _execute(self):
        ...
        while stack:
            ...
            elif frame._op.require_executed_base():
    ...
    def _require_executed_base(self):
        ...
        bool
        """
        return self._uses_rowid or self._op.require_executed_base()
